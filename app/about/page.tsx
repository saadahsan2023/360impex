                ...
                <div className="mb-16 text-center">
                    ...
                    <div className="relative overflow-hidden">
                        <div className="flex animate-scroll whitespace-nowrap">
                            {[
                                { name: 'USA', image: '/usa.png' },
                                { name: 'China', image: '/china.png' },
                                { name: 'Japan', image: '/japan.png' },
                                { name: 'Germany', image: '/germany.png' },
                                { name: 'Indonesia', image: '/indonesia.png' },
                            ].map((country, index) => (
                                <div key={index} className="flex-none w-40 sm:w-48 mx-4 text-center">
                                    <img
                                        src={country.image}
                                        alt={`${country.name} Map`}
                                        className="w-24 h-24 sm:w-32 sm:h-32 mx-auto mb-2 object-contain rounded-lg shadow-md"
                                    />
                                    <span className="text-[#7ed957] font-medium">{country.name}</span>
                                </div>
                            ))}
                            ...
                            {[
                                ...
                                <div key={`duplicate-${index}`} className="flex-none w-40 sm:w-48 mx-4 text-center">
                                    <img
                                        src={country.image}
                                        alt={`${country.name} Map`}
                                        className="w-24 h-24 sm:w-32 sm:h-32 mx-auto mb-2 object-contain rounded-lg shadow-md"
