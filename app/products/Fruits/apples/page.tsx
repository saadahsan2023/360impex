            ...
            <section className="bg-[#141C2C] text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: 'Crisp Texture', description: 'Harvested at peak freshness for a satisfying crunch.' },
                            { title: 'Nutrient-Packed', description: 'Rich in vitamins and fiber for a healthy snack.' },
                            { title: 'Export Ready', description: 'Carefully packaged to meet global distribution standards.' }
                        ].map((item, idx) => (
