            ...
            <section className="bg-[#141C2C] text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: 'Peak Ripeness', description: 'Harvested at the perfect moment for maximum sweetness and juiciness.' },
                            { title: 'Rich Flavor', description: 'Offers a juicy, aromatic taste that delights the senses.' },
