...
//         <>
//             <Head>
//                 <title>Bananas | 360 Impex</title>
//                 <meta name="description" content="Sweet Bananas from 360 Impex, fresh and ready for export." />
//             </Head>
...
//                             style={{ fontFamily: "'Montserrat', sans-serif" }}
//                         >
//                             At <span className="text-white font-semibold">360 Impex</span>, we supply sweet, ripe bananas, sourced from premium farms. Packed with energy and nutrients, our bananas are ideal for export and local markets.
//                         </p>
//                         <div className="mt-6">
...
//                                     style={{ fontFamily: "'Montserrat', sans-serif" }}
//                                     aria-label="Request a quote for Bananas"
//                                 >
//                                     Request a Quote
//                                 </button>
//                             </Link>
...
//                     {[
//                         { title: 'Ripe and Sweet', desc: 'Harvested at peak ripeness.' },
//                         { title: 'Energy Source', desc: 'Rich in potassium and carbs.' },
//                         { title: 'Export Quality', desc: 'Packaged for global trade.' }
//                     ].map((item, idx) => (
            ...
            <section className="bg-[#141C2C] text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: 'Ripe and Sweet', description: 'Harvested at peak ripeness for maximum flavor and sweetness.' },
                            { title: 'Energy Source', description: 'Rich in potassium and carbohydrates for a natural energy boost.' },
                            { title: 'Export Quality', description: 'Carefully packaged to meet international trade standards.' }
                        ].map((item, idx) => (
