...
//         <>
//             <Head>
//                 <title>Pomegranates | 360 Impex</title>
//                 <meta name="description" content="Antioxidant-Rich Pomegranates from 360 Impex, fresh for export." />
//             </Head>
...
//                             style={{ fontFamily: "'Montserrat', sans-serif" }}
//                         >
//                             At <span className="text-white font-semibold">360 Impex</span>, we supply fresh pomegranates, packed with antioxidants and flavor. Sourced from premium groves, our pomegranates are perfect for health-conscious markets worldwide.
//                         </p>
//                         <div className="mt-6">
...
//                                     style={{ fontFamily: "'Montserrat', sans-serif" }}
//                                     aria-label="Request a quote for Pomegranates"
//                                 >
//                                     Request a Quote
//                                 </button>
//                             </Link>
...
//                     {[
//                         { title: 'Antioxidant-Rich', desc: 'High in vitamins and polyphenols.' },
//                         { title: 'Fresh Harvest', desc: 'Picked at peak ripeness.' },
            ...
            <section className="bg-[#141C2C] text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto">
                    <h2
                        ...
                        style={{ fontFamily: "'Montserrat', sans-serif" }}
                    >
                        Features of Pomegranates
                    </h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: 'Antioxidant-Rich', description: 'High in vitamins and polyphenols for health benefits.' },
                            { title: 'Fresh Harvest', description: 'Picked at peak ripeness for optimal flavor and juiciness.' },
                            { title: 'Export Quality', description: 'Carefully packaged to meet global market standards.' }
                        ].map((item, idx) => (
