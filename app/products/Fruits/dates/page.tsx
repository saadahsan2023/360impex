...
//         <>
//             <Head>
//                 <title>Dates | 360 Impex</title>
//                 <meta name="description" content="Natural Dates from 360 Impex, sweet and nutritious for export." />
//             </Head>
...
//                             style={{ fontFamily: "'Montserrat', sans-serif" }}
//                         >
//                             Nature's Sweet Treasure
//                         </p>
//                         <p
//                             className="text-lg sm:text-xl text-gray-400 leading-relaxed"
//                             style={{ fontFamily: "'Montserrat', sans-serif" }}
//                         >
//                             At <span className="text-white font-semibold">360 Impex</span>, we offer natural dates, packed with sweetness and nutrition. Sourced from premium palm groves, our dates are perfect for snacks, cooking, and global export.
//                         </p>
//                         <div className="mt-6">
...
//                                     style={{ fontFamily: "'Montserrat', sans-serif" }}
//                                     aria-label="Request a quote for Dates"
//                                 >
//                                     Request a Quote
//                                 </button>
//                             </Link>
...
//                     {[
//                         { title: 'Natural Sweetness', desc: 'No added sugars or preservatives.' },
//                         { title: 'Nutrient-Dense', desc: 'Rich in fiber and minerals.' },
//                         { title: 'Export Quality', desc: 'Packaged for international markets.' }
//                     ].map((item, idx) => (
            ...
            <section className="bg-[#141C2C] text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: 'Natural Sweetness', description: 'Purely natural with no added sugars or preservatives for authentic flavor.' },
                            { title: 'Nutrient-Dense', description: 'Rich in fiber, vitamins, and minerals for a healthy snack.' },
                            { title: 'Export Quality', description: 'Carefully packaged to meet international market standards.' }
                        ].map((item, idx) => (
