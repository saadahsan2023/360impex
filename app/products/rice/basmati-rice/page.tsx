...
export default function BasmatiRice() {
    ...
    return (
        <>
            <Head>
                <title>Basmati Rice | 360 Impex</title>
                <meta name="description" content="Premium Basmati Rice from 360 Impex, aromatic and exported globally." />
            </Head>
            <section className="bg-gradient-to-b from-gray-900 to-gray-800 text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="animate-fade-in-up space-y-6">
                        ...
                        <p
                            ...
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            Aromatic Grain of Excellence
                        </p>
                        <p
                            className="text-lg sm:text-xl text-gray-400 leading-relaxed"
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            At <span className="text-white font-semibold">360 Impex</span>, we offer premium basmati rice, known for its long grains and rich aroma. Sourced from the finest fields, it's perfect for gourmet dishes and global export.
                        </p>
                        <div className="mt-6">
                            <Link href="/request-a-quote">
                                <button
                                    ...
                                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                                    aria-label="Request a quote for Basmati Rice"
                                >
                                    Request a Quote
                                </button>
                            </Link>
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                    {[
                        { title: 'Long Grains', desc: 'Elongates perfectly when cooked.' },
                        { title: 'Rich Aroma', desc: 'Natural fragrance enhances dishes.' },
