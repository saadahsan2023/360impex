...
//                             style={{ fontFamily: "'Montserrat', sans-serif" }}
//                         >
//                             At <span className="text-white font-semibold">360 Impex</span>, we offer a variety of premium rice, sourced from fertile fields. Known for their taste and texture, our rice varieties cater to global culinary and export needs.
//                         </p>
//                         <div className="mt-6">
...
//                                     style={{ fontFamily: "'Montserrat', sans-serif" }}
//                                     aria-label="Request a quote for Rice"
//                                 >
//                                     Request a Quote
//                                 </button>
//                             </Link>
...
//                         {[
//                             { name: 'Basmati Rice', path: '/products/rice/basmati-rice' },
//                             { name: 'Non-Basmati Rice', path: '/products/rice/non-basmati-rice' },
//                             { name: 'Sella Rice', path: '/products/rice/sella-rice' }
//                         ].map((product, idx) => (
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            { name: 'Non-Basmati Rice', path: '/products/rice/non-basmati-rice', description: 'Versatile rice varieties for everyday culinary needs.', image: '/decorative-salt.jpg' },
                            { name: 'Sella Rice', path: '/products/rice/sella-rice', description: 'Parboiled rice with enhanced texture and flavor.', image: '/decorative-salt.jpg' }
                        ].map((product, idx) => (
                            <Link key={idx} href={product.path}>
