...
export default function SellaRice() {
    useEffect(() => {
        const styles = `
    ...
    return (
        <>
            ...
            <Head>
                <title>Sella Rice | 360 Impex</title>
                <meta name="description" content="Premium Sella Rice from 360 Impex, parboiled for export quality." />
            </Head>
            <section className="bg-gradient-to-b from-gray-900 to-gray-800 text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="animate-fade-in-up space-y-6">
                        ...
                        <p
                            ...
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            At <span className="text-white font-semibold">360 Impex</span>, we supply premium sella rice, parboiled for enhanced nutrition and texture. Sourced from top fields, it's a favorite for export and culinary use.
                        </p>
                        <div className="mt-6">
                            <Link href="/request-a-quote">
                                <button
                                    ...
                                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                                    aria-label="Request a quote for Sella Rice"
                                >
                                    Request a Quote
                                </button>
                            </Link>
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                    {[
                        { title: 'Parboiled', desc: 'Retains nutrients during cooking.' },
                        { title: 'Consistent Texture', desc: 'Non-sticky and fluffy grains.' },
