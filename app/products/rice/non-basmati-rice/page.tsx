...
export default function NonBasmatiRice() {
    ...
    return (
        <>
            <Head>
                <title>Non-Basmati Rice | 360 Impex</title>
                <meta name="description" content="Versatile Non-Basmati Rice from 360 Impex, perfect for everyday use." />
            </Head>
            <section className="bg-gradient-to-b from-gray-900 to-gray-800 text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="animate-fade-in-up space-y-6">
                        ...
                        <p
                            ...
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            Everyday Staple Grain
                        </p>
                        <p
                            className="text-lg sm:text-xl text-gray-400 leading-relaxed"
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            At <span className="text-white font-semibold">360 Impex</span>, we provide high-quality non-basmati rice, ideal for daily meals. Sourced from fertile fields, it offers great taste and texture for households and export markets.
                        </p>
                        <div className="mt-6">
                            <Link href="/request-a-quote">
                                <button
                                    ...
                                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                                    aria-label="Request a quote for Non-Basmati Rice"
                                >
                                    Request a Quote
                                </button>
                            </Link>
                    ...
                    <div className="flex justify-center md:justify-end">
                        <div className="relative w-full max-w-md h-[320px] sm:h-[400px] max-h-[400px]">
                            <Image
                                src="/image/non-basmati-rice.jpg"
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                    {[
                        { title: 'Short Grains', desc: 'Perfect for sticky textures.' },
                        { title: 'Affordable Quality', desc: 'Great value for daily use.' },
                        { title: 'Export Ready', desc: 'Packaged for global supply.' }
                    ].map((item, idx) => (
