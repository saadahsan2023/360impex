...
export default function Ginger() {
    ...
    return (
        <>
            <Head>
                <title>Ginger | 360 Impex</title>
                <meta name="description" content="Fresh Ginger from 360 Impex, packed with flavor and health benefits." />
            </Head>
            <section className="bg-gradient-to-b from-gray-900 to-gray-800 text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="animate-fade-in-up space-y-6">
                        ...
                        <p
                            ...
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            At <span className="text-white font-semibold">360 Impex</span>, we provide fresh ginger, packed with flavor and medicinal properties. Sourced from premium farms, our ginger is ideal for culinary use, teas, and export markets.
                        </p>
                        <div className="mt-6">
                            <Link href="/request-a-quote">
                                <button
                                    ...
                                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                                    aria-label="Request a quote for Ginger"
                                >
                                    Request a Quote
                                </button>
                            </Link>
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                    {[
                        { title: 'Freshly Sourced', desc: 'Harvested at peak potency.' },
                        { title: 'Health Boost', desc: 'Supports digestion and immunity.' },
                        { title: 'Export Quality', desc: 'Packaged for global distribution.' }
                    ].map((item, idx) => (
