...
export default function Garlic() {
    ...
    return (
        <>
            <Head>
                <title>Garlic | 360 Impex</title>
                <meta name="description" content="Premium Garlic from 360 Impex, fresh and packed for global supply." />
            </Head>
            <section className="bg-gradient-to-b from-gray-900 to-gray-800 text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="animate-fade-in-up space-y-6">
                        ...
                        <p
                            ...
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            Aromatic Essence of Nature
                        </p>
                        <p
                            className="text-lg sm:text-xl text-gray-400 leading-relaxed"
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            At <span className="text-white font-semibold">360 Impex</span>, we offer top-quality garlic, freshly harvested and packed for global markets. Known for its robust flavor and health benefits, our garlic is a culinary staple and export favorite.
                        </p>
                        <div className="mt-6">
                            <Link href="/request-a-quote">
                                <button
                                    ...
                                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                                    aria-label="Request a quote for Garlic"
                                >
                                    Request a Quote
                                </button>
                            </Link>
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                    {[
                        { title: 'Fresh Harvest', desc: 'Picked at optimal maturity.' },
                        { title: 'Health Benefits', desc: 'Rich in antioxidants and vitamins.' },
                        { title: 'Export Ready', desc: 'Packaged for international trade.' }
                    ].map((item, idx) => (
