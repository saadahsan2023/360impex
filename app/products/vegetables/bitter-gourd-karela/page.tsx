...
export default function BitterGourdKarela() {
    useEffect(() => {
        const styles = `
    ...
    return (
        <>
            <Head>
                <title>Bitter Gourd (Karela) | 360 Impex</title>
                <meta name="description" content="Fresh Bitter Gourd (Karela) from 360 Impex, packed with health benefits." />
            </Head>
            <section className="bg-gradient-to-b from-gray-900 to-gray-800 text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="animate-fade-in-up space-y-6">
                        ...
                        <p
                            ...
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            Nature’s Health Powerhouse
                        </p>
                        <p
                            className="text-lg sm:text-xl text-gray-400 leading-relaxed"
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            At <span className="text-white font-semibold">360 Impex</span>, we supply fresh bitter gourd (karela), renowned for its health benefits. Packed with nutrients, it’s perfect for traditional dishes and export markets seeking natural wellness.
                        </p>
                        <div className="mt-6">
                            <Link href="/request-a-quote">
                                <button
                                    ...
                                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                                    aria-label="Request a quote for Bitter Gourd (Karela)"
                                >
                                    Request a Quote
                                </button>
                            </Link>
                    ...
                    <div className="flex justify-center md:justify-end">
                        <div className="relative w-full max-w-md h-[320px] sm:h-[400px] max-h-[400px]">
                            <Image
                                src="/image/bitter-gourd-karela.jpg"
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                    {[
                        { title: 'Nutrient-Rich', desc: 'High in vitamins and antioxidants.' },
                        { title: 'Health Benefits', desc: 'Supports blood sugar control.' },
                        { title: 'Fresh Supply', desc: 'Harvested and packed daily.' }
                    ].map((item, idx) => (
