            ...
            <section className="bg-gradient-to-b from-gray-900 to-gray-800 text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                        {[
                            { name: 'Onions', path: '/products/onions' },
                            { name: 'Garlic', path: '/products/garlic' },
                            { name: 'Ginger', path: '/products/ginger' },
                            { name: 'Dry Chilies', path: '/products/dry-chilies' },
                            { name: 'Bitter Gourd (Karela)', path: '/products/bitter-gourd-karela' },
                            { name: 'Potato', path: '/products/patato' }
                        ].map((product, idx) => (
