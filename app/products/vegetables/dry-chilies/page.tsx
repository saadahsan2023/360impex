...
export default function DryChilies() {
    useEffect(() => {
        const styles = `
    ...
    return (
        <>
            <Head>
                <title>Dry Chilies | 360 Impex</title>
                <meta name="description" content="Spicy Dry Chilies from 360 Impex, perfect for culinary and industrial use." />
            </Head>
            <section className="bg-gradient-to-b from-gray-900 to-gray-800 text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="animate-fade-in-up space-y-6">
                        ...
                        <p
                            ...
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            Bold Spice in Every Bite
                        </p>
                        <p
                            className="text-lg sm:text-xl text-gray-400 leading-relaxed"
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            At <span className="text-white font-semibold">360 Impex</span>, we offer premium dry chilies, sun-dried to perfection for maximum flavor. Ideal for culinary dishes or industrial spice blends, our chilies are exported globally.
                        </p>
                        <div className="mt-6">
                            <Link href="/request-a-quote">
                                <button
                                    ...
                                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                                    aria-label="Request a quote for Dry Chilies"
                                >
                                    Request a Quote
                                </button>
                            </Link>
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                    {[
                        { title: 'Sun-Dried', desc: 'Naturally dried for intense flavor.' },
                        { title: 'Versatile Use', desc: 'Perfect for cooking and spices.' },
                        { title: 'Export Standard', desc: 'Packaged for global markets.' }
                    ].map((item, idx) => (
