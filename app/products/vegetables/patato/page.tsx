...
export default function Potato() {
    ...
    return (
        <>
            <Head>
                <title>Potato | 360 Impex</title>
                <meta name="description" content="Fresh Potatoes from 360 Impex, perfect for culinary and industrial use." />
            </Head>
            <section className="bg-gradient-to-b from-gray-900 to-gray-800 text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="animate-fade-in-up space-y-6">
                        ...
                        <p
                            ...
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            Versatile Staple from the Soil
                        </p>
                        <p
                            className="text-lg sm:text-xl text-gray-400 leading-relaxed"
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            At <span className="text-white font-semibold">360 Impex</span>, we deliver fresh potatoes, grown and packed for culinary excellence and industrial needs. Our potatoes are a reliable choice for global markets and local kitchens.
                        </p>
                        <div className="mt-6">
                            <Link href="/request-a-quote">
                                <button
                                    ...
                                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                                    aria-label="Request a quote for Potato"
                                >
                                    Request a Quote
                                </button>
                            </Link>
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                    {[
                        { title: 'Freshly Dug', desc: 'Harvested at peak freshness.' },
                        { title: 'Versatile Use', desc: 'Ideal for cooking and processing.' },
                        { title: 'Export Quality', desc: 'Packaged for global delivery.' }
                    ].map((item, idx) => (
