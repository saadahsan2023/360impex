...
export default function Onions() {
    ...
    return (
        <>
            <Head>
                <title>Onions | 360 Impex</title>
                <meta name="description" content="High-quality Onions from 360 Impex, fresh and sourced for global markets." />
            </Head>
            <section className="bg-gradient-to-b from-gray-900 to-gray-800 text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="animate-fade-in-up space-y-6">
                        ...
                        <p
                            ...
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            Fresh Flavor from the Fields
                        </p>
                        <p
                            className="text-lg sm:text-xl text-gray-400 leading-relaxed"
                            style={{ fontFamily: "'Montserrat', sans-serif" }}
                        >
                            At <span className="text-white font-semibold">360 Impex</span>, we supply premium onions, freshly harvested and packed to meet global standards. Rich in flavor and nutrition, our onions are perfect for culinary use and bulk export.
                        </p>
                        <div className="mt-6">
                            <Link href="/request-a-quote">
                                <button
                                    ...
                                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                                    aria-label="Request a quote for Onions"
                                >
                                    Request a Quote
                                </button>
                            </Link>
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                    {[
                        ...
                        { title: 'Rich Flavor', desc: 'Enhances every dish.' },
                        { title: 'Export Quality', desc: 'Meets international standards.' }
                    ].map((item, idx) => (
