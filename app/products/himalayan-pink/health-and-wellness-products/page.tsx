...
// export default function HealthAndWellnessProducts() {
//     useEffect(() => {
//         const styles = `
...
//         <>
//             <Head>
//                 <title>Health and Wellness Products | 360 Impex</title>
//                 <meta name="description" content="Explore Health and Wellness Products from 360 Impex, made with Himalayan salt." />
//             </Head>
...
//                             style={{ fontFamily: "'Montserrat', sans-serif" }}
//                         >
//                             Natural Healing with Himalayan Salt
//                         </p>
//                         <p
//                             className="text-lg sm:text-xl text-gray-400 leading-relaxed"
//                             style={{ fontFamily: "'Montserrat', sans-serif" }}
//                         >
//                             At <span className="text-white font-semibold">360 Impex</span>, we offer health and wellness products crafted from Himalayan salt, including bath salts and inhalers. These products promote relaxation, respiratory health, and overall well-being with natural purity.
//                         </p>
//                         <div className="mt-6">
...
//                                     style={{ fontFamily: "'Montserrat', sans-serif" }}
//                                     aria-label="Request a quote for Health and Wellness Products"
//                                 >
//                                     Request a Quote
//                                 </button>
//                             </Link>
...
//                     {[
//                         { title: 'Natural Therapy', desc: 'Promotes relaxation and health.' },
//                         { title: 'Respiratory Benefits', desc: 'Aids breathing with salt inhalers.' },
//                         { title: 'Pure Ingredients', desc: 'Made from 100% Himalayan salt.' }
//                     ].map((item, idx) => (
            ...
            <section className="bg-[#141C2C] text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto">
                    <h2
                        ...
                        style={{ fontFamily: "'Montserrat', sans-serif" }}
                    >
                        Features of Health and Wellness Products
                    </h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: 'Natural Therapy', description: 'Promotes relaxation and holistic health benefits.' },
                            { title: 'Respiratory Benefits', description: 'Supports breathing with Himalayan salt inhalers.' },
                            { title: 'Pure Ingredients', description: 'Crafted from 100% natural Himalayan salt.' }
                        ].map((item, idx) => (
