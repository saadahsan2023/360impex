...
//         <>
//             <Head>
//                 <title>Decorative Products | 360 Impex</title>
//                 <meta name="description" content="Discover stunning Decorative Products from 360 Impex, crafted from Himalayan salt." />
//             </Head>
...
//                             style={{ fontFamily: "'Montserrat', sans-serif" }}
//                         >
//                             Exquisite Art from Himalayan Salt
//                         </p>
//                         <p
//                             className="text-lg sm:text-xl text-gray-400 leading-relaxed"
//                             style={{ fontFamily: "'Montserrat', sans-serif" }}
//                         >
//                             At <span className="text-white font-semibold">360 Impex</span>, we offer stunning decorative items made from Himalayan rock salt. From elegant lamps to unique sculptures, our products blend natural beauty with craftsmanship, perfect for home or commercial decor.
//                         </p>
//                         <div className="mt-6">
...
//                                     style={{ fontFamily: "'Montserrat', sans-serif" }}
//                                     aria-label="Request a quote for Decorative Products"
//                                 >
//                                     Request a Quote
//                                 </button>
//                             </Link>
...
//                     {[
//                         { title: 'Unique Designs', desc: 'Handcrafted with Himalayan salt.' },
//                         { title: 'Ambient Lighting', desc: 'Creates a warm, inviting glow.' },
//                         { title: 'Durable Craftsmanship', desc: 'Built to last with natural materials.' }
//                     ].map((item, idx) => (
            ...
            <section className="bg-[#141C2C] text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: 'Unique Designs', description: 'Handcrafted with Himalayan salt for one-of-a-kind aesthetics.' },
                            { title: 'Ambient Lighting', description: 'Creates a warm, inviting glow for any space.' },
                            { title: 'Durable Craftsmanship', description: 'Built to last using natural, high-quality materials.' }
                        ].map((item, idx) => (
