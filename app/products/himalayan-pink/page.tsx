...
// export default function HimalayanPink() {
//     useEffect(() => {
//         const styles = `
...
//         <>
//             <Head>
//                 <title>Himalayan Pink | 360 Impex</title>
//                 <meta name="description" content="Explore Himalayan Pink Salt products from 360 Impex, pure and natural for global markets." />
//             </Head>
...
//                             style={{ fontFamily: "'Montserrat', sans-serif" }}
//                         >
//                             Nature's Purest Salt
//                         </p>
//                         <p
//                             className="text-lg sm:text-xl text-gray-400 leading-relaxed"
//                             style={{ fontFamily: "'Montserrat', sans-serif" }}
//                         >
//                             At <span className="text-white font-semibold">360 Impex</span>, we bring you the finest Himalayan Pink Salt, mined from ancient salt deposits. Rich in minerals and unrefined, it's perfect for culinary use, wellness, and export markets.
//                         </p>
//                         <div className="mt-6">
...
//                                     style={{ fontFamily: "'Montserrat', sans-serif" }}
//                                     aria-label="Request a quote for Himalayan Pink"
//                                 >
//                                     Request a Quote
//                                 </button>
//                             </Link>
...
//                         style={{ fontFamily: "'Montserrat', sans-serif" }}
//                     >
//                         Our Himalayan Pink Products
//                     </h2>
//                     <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
//                         {[
//                             { name: 'Edible Salt', path: '/products/himalayan-pink/edible-salt' },
//                             { name: 'Industrial Salt', path: '/products/himalayan-pink/industrial-salt' },
//                             { name: 'Health and Wellness', path: '/products/himalayan-pink/health-and-wellness-products' },
//                             { name: 'Himalayan Pink Salt Lamps', path: '/products/himalayan-pink/himalayan-salt-lamps' },
//                             { name: 'Decorative Products', path: '/products/himalayan-pink/decorative-products' },
//                             { name: 'Himalayan Pink Salt Edible', path: '/products/himalayan-pink/animal-lick-salt' }
//                         ].map((product, idx) => (
            ...
            <section className="bg-[#141C2C] text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { name: 'Edible Salt', path: '/products/himalayan-pink/edible-salt', description: 'Pure, mineral-rich salt for culinary excellence.', image: '/himalayan/img2.jpg' },
                            { name: 'Animal Lick Salt', path: '/products/himalayan-pink/animal-lick-salt', description: 'Nutritious salt licks for livestock health.', image: '/himalayan/Animal-Lick-Salt.jpg' },
                            { name: 'Himalayan Pink Salt Lamps', path: '/products/himalayan-pink/himalayan-salt-lamps', description: 'Elegant lamps for ambiance and air purification.', image: '/himalayan/Rock-Salt-Lamps.jpg' },
                            { name: 'Industrial Salt', path: '/products/himalayan-pink/industrial-salt', description: 'High-quality salt for industrial applications.', image: '/himalayan/img4.jpg' },
                            { name: 'Health and Wellness', path: '/products/himalayan-pink/health-and-wellness-products', description: 'Natural salt products for wellness and spa use.', image: '/himalayan/img6.jpg' },

                            { name: 'Decorative Products', path: '/products/himalayan-pink/decorative-products', description: 'Unique, handcrafted salt decor items.', image: '/himalayan/img3.jpg' },
