...
// export default function AnimalLickSalt() {
//     useEffect(() => {
//         const styles = `
...
//         <>
//             <Head>
//                 <title>Animal Lick Salt | 360 Impex</title>
//                 <meta name="description" content="Explore premium Animal Lick Salt from 360 Impex, Pakistan’s trusted supplier and manufacturer." />
//             </Head>
...
//                             style={{ fontFamily: "'Montserrat', sans-serif" }}
//                         >
//                             At <span className="text-white font-semibold">360 Impex</span>, we provide high-quality Animal Lick Salt, crafted from pure Himalayan rock salt. Enriched with essential minerals, our lick salts promote livestock health and vitality, making them ideal for cattle, sheep, and goats.
//                         </p>
//                         <div className="mt-6">
...
//                                     style={{ fontFamily: "'Montserrat', sans-serif" }}
//                                     aria-label="Request a quote for Animal Lick Salt"
//                                 >
//                                     Request a Quote
//                                 </button>
//                             </Link>
...
//                     {[
//                         { title: 'Natural Minerals', desc: 'Rich in sodium and trace elements.' },
//                         { title: 'Livestock Health', desc: 'Supports growth and digestion.' },
//                         { title: 'Durable Design', desc: 'Long-lasting for outdoor use.' }
//                     ].map((item, idx) => (
            ...
            <section className="bg-[#141C2C] text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="flex justify-center md:justify-end">
                        <div className="relative w-full max-w-md h-[320px] sm:h-[400px] max-h-[400px]">
                            <Image
                                src="/himalayan/Animal-Lick-Salt.jpg"
                                alt="Animal Lick Salt"
                                layout="fill"
                                objectFit="cover"
                                className="rounded-2xl shadow-2xl border-4 border-[#7ed95730]"
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto">
                    <h2
                        ...
                        style={{ fontFamily: "'Montserrat', sans-serif" }}
                    >
                        Features of Animal Lick Salt
                    </h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: 'Natural Minerals', description: 'Rich in sodium and trace elements essential for livestock.' },
                            { title: 'Livestock Health', description: 'Supports growth, digestion, and overall vitality.' },
                            { title: 'Durable Design', description: 'Long-lasting and suitable for outdoor use.' }
                        ].map((item, idx) => (
