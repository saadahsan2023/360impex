...
//                         {[
//                             { name: 'Desi Cotton (Gossypium Arboreum)', path: '/products/cotton/desi-cotton-gossypium-arboreum' },
//                             { name: 'American Cotton (Gossypium Hirsutum)', path: '/products/cotton/american-cotton-gossypium-hirsutum' }
//                         ].map((product, idx) => (
