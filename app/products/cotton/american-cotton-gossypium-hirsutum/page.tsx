...
// export default function AmericanCotton() {
//     useEffect(() => {
//         const styles = `
...
//         <>
//             <Head>
//                 <title>American Cotton (Gossypium Hirsutum) | 360 Impex</title>
//                 <meta name="description" content="Premium American Cotton (Gossypium Hirsutum) from 360 Impex, perfect for high-quality textiles." />
//             </Head>
...
//                             style={{ fontFamily: "'Montserrat', sans-serif" }}
//                         >
//                             Global Standard for Textiles
//                         </p>
//                         <p
//                             className="text-lg sm:text-xl text-gray-400 leading-relaxed"
//                             style={{ fontFamily: "'Montserrat', sans-serif" }}
//                         >
//                             At <span className="text-white font-semibold">360 Impex</span>, we supply high-quality American Cotton (Gossypium Hirsutum), known for its soft fibers and versatility. Perfect for premium textiles, it meets global industry standards.
//                         </p>
//                         <div className="mt-6">
...
//                                     style={{ fontFamily: "'Montserrat', sans-serif" }}
//                                     aria-label="Request a quote for American Cotton (Gossypium Hirsutum)"
//                                 >
//                                     Request a Quote
//                                 </button>
//                             </Link>
...
//                     {[
//                         { title: 'Soft Fibers', desc: 'Ideal for premium fabrics.' },
//                         { title: 'High Yield', desc: 'Efficient for large-scale production.' },
//                         { title: 'Export Quality', desc: 'Meets international textile standards.' }
//                     ].map((item, idx) => (
            ...
            <section className="bg-[#141C2C] text-white min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
                ...
                <div className="relative z-10 mt-16 sm:mt-24 max-w-6xl mx-auto">
                    <h2
                        ...
                        style={{ fontFamily: "'Montserrat', sans-serif" }}
                    >
                        Features of American Cotton
                    </h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            { title: 'Soft Fibers', description: 'Ideal for premium fabrics, offering unmatched comfort and quality.' },
                            { title: 'High Yield', description: 'Efficient for large-scale production, ensuring cost-effective supply.' },
                            { title: 'Export Quality', description: 'Meets international textile standards for global market demands.' }
                        ].map((item, idx) => (
